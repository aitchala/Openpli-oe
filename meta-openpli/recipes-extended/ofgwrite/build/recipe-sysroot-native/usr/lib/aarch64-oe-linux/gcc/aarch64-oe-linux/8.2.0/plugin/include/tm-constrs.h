/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/aarch64.md'.  */
...
#line 42 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 47 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_J (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 64 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_uimm12_shift (-ival)));
}
static inline bool
satisfies_constraint_K (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 73 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_L (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 78 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_M (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 83 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_N (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 88 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
#line 94 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_UsO (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 99 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_UsP (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 104 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_S (rtx op)
{
  ...
  return 
#line 109 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
#line 114 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return 
#line 118 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(op == const0_rtx);
}
static inline bool
...
#line 123 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Usa (rtx op)
{
  ...
  return (
#line 130 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_symbolic_address_p (op))) && (
#line 131 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Uss (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 137 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Usn (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 142 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(IN_RANGE (ival, -31, 0)));
}
static inline bool
satisfies_constraint_Usd (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 148 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
#line 153 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Usg (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 161 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(IN_RANGE (ival, 1, 31)));
}
static inline bool
satisfies_constraint_Usj (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 168 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(IN_RANGE (ival, 1, 63)));
}
static inline bool
...
{
  return 
#line 173 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(op == constm1_rtx);
}
static inline bool
...
{
  return 
#line 190 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(op == const1_rtx);
}
static inline bool
satisfies_constraint_Ui2 (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 196 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Ui3 (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 202 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Ui7 (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 208 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Up3 (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 214 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 219 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(REG_P (XEXP (op, 0))));
}
static inline bool
...
{
  return (GET_CODE (op) == MEM) && (
#line 226 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 233 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 242 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 250 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 257 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 263 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 270 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 282 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 288 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
#line 294 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 301 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_simd_valid_immediate (op, NULL,
						 AARCH64_CHECK_BIC)));
}
static inline bool
satisfies_constraint_Dn (rtx op)
{
  ...
  return 
#line 308 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_simd_valid_immediate (op, NULL));
}
static inline bool
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 315 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 323 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_simd_scalar_immediate_valid_for_move (op,
						 QImode)));
}
static inline bool
satisfies_constraint_Dl (rtx op)
{
  ...
  return 
#line 330 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Dr (rtx op)
{
  ...
  return 
#line 337 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
(aarch64_simd_shift_imm_p (op, GET_MODE (op),
						 false));
}
static inline bool
satisfies_constraint_Dz (rtx op)
{
  ...
  return 
#line 343 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
satisfies_constraint_Dm (rtx op)
{
  ...
  return 
#line 349 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 356 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 363 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
...
{
  return 
#line 368 "../../../../../../../work-shared/gcc-8.2.0-r0/gcc-8.2.0/gcc/config/aarch64/constraints.md"
