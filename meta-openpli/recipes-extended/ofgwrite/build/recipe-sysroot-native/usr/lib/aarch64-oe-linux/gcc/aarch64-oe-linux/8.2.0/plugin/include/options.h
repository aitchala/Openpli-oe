...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 343,      /* -Wpoison-system-directories */
  ...
  OPT_fcilkplus_Undocumented = 560,          /* -fcilkplus Undocumented */
  ...
  OPT_nostdlib__ = 1227,                     /* -nostdlib++ */
  OPT_o = 1228,                              /* -o */
  OPT_p = 1229,                              /* -p */
  OPT_pass_exit_codes = 1230,                /* -pass-exit-codes */
  /* OPT_pedantic = 1231, */                 /* -pedantic */
  OPT_pedantic_errors = 1232,                /* -pedantic-errors */
  OPT_pg = 1233,                             /* -pg */
  OPT_pie = 1234,                            /* -pie */
  OPT_pipe = 1235,                           /* -pipe */
  OPT_posix = 1236,                          /* -posix */
  OPT_print_file_name_ = 1237,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1238,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1239,          /* -print-multi-directory */
  OPT_print_multi_lib = 1240,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1241,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1242,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1243,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1244,               /* -print-prog-name= */
  OPT_print_search_dirs = 1245,              /* -print-search-dirs */
  OPT_print_sysroot = 1246,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1247,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1248,                        /* -profile */
  OPT_pthread = 1249,                        /* -pthread */
  OPT_quiet = 1250,                          /* -quiet */
  OPT_r = 1251,                              /* -r */
  OPT_rdynamic = 1252,                       /* -rdynamic */
  OPT_remap = 1253,                          /* -remap */
  OPT_s = 1254,                              /* -s */
  OPT_save_temps = 1255,                     /* -save-temps */
  OPT_save_temps_ = 1256,                    /* -save-temps= */
  OPT_shared = 1257,                         /* -shared */
  OPT_shared_libgcc = 1258,                  /* -shared-libgcc */
  /* OPT_specs = 1259, */                    /* -specs */
  OPT_specs_ = 1260,                         /* -specs= */
  OPT_static = 1261,                         /* -static */
  OPT_static_libasan = 1262,                 /* -static-libasan */
  OPT_static_libgcc = 1263,                  /* -static-libgcc */
  OPT_static_libgfortran = 1264,             /* -static-libgfortran */
  OPT_static_libgo = 1265,                   /* -static-libgo */
  OPT_static_liblsan = 1266,                 /* -static-liblsan */
  OPT_static_libmpx = 1267,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1268,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1269,               /* -static-libstdc++ */
  OPT_static_libtsan = 1270,                 /* -static-libtsan */
  OPT_static_libubsan = 1271,                /* -static-libubsan */
  OPT_static_pie = 1272,                     /* -static-pie */
  /* OPT_std_c__03 = 1273, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1274, */                /* -std=c++0x */
  OPT_std_c__11 = 1275,                      /* -std=c++11 */
  OPT_std_c__14 = 1276,                      /* -std=c++14 */
  OPT_std_c__17 = 1277,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1278, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1279, */                /* -std=c++1z */
  OPT_std_c__2a = 1280,                      /* -std=c++2a */
  OPT_std_c__98 = 1281,                      /* -std=c++98 */
  OPT_std_c11 = 1282,                        /* -std=c11 */
  OPT_std_c17 = 1283,                        /* -std=c17 */
  /* OPT_std_c18 = 1284, */                  /* -std=c18 */
  /* OPT_std_c1x = 1285, */                  /* -std=c1x */
  /* OPT_std_c89 = 1286, */                  /* -std=c89 */
  OPT_std_c90 = 1287,                        /* -std=c90 */
  OPT_std_c99 = 1288,                        /* -std=c99 */
  /* OPT_std_c9x = 1289, */                  /* -std=c9x */
  OPT_std_f2003 = 1290,                      /* -std=f2003 */
  OPT_std_f2008 = 1291,                      /* -std=f2008 */
  OPT_std_f2008ts = 1292,                    /* -std=f2008ts */
  OPT_std_f2018 = 1293,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1303,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1304,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1305,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1306,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1307, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1308, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1309, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1310,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1311,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1312, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1313, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1314,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1315, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1316, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1317, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1318, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1319, */         /* -std=iso9899:2018 */
