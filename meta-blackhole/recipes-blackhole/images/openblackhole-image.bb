...
ENIGMA2_PLUGINS = " \
	...
	\
	${@bb.utils.contains("MACHINE", "vusolo2", "enigma2-plugin-extensions-hbbtv", "", d)} \
	${@bb.utils.contains("MACHINE", "vuduo2", "enigma2-plugin-extensions-hbbtv", "", d)} \
	${@bb.utils.contains("MACHINE", "vusolose", "enigma2-plugin-extensions-hbbtv", "", d)} \
  	${@bb.utils.contains("MACHINE", "vuzero", "enigma2-plugin-extensions-hbbtv", "", d)} \
	"
...
DVB_USB_DRIVERS = " \
	...
	${@bb.utils.contains('PREFERRED_VERSION_linux-ceryon', '3.14.2', 'enigma2-plugin-drivers-dvb-usb-it913x', '', d)} \
...
IMAGE_INSTALL += " \
	...
	${ENIGMA2_PLUGINS} \
	\
	${@bb.utils.contains("MACHINE_FEATURES", "tpm", "tpmd", "", d)} \
